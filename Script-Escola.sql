...
INSERT INTO notas (, alunos_id, disciplinas_id) VALUES (15,4);
...
select a.id, a.nome, a.ra, d.nome as disciplina from alunos a inner join registro_alunos_disciplinas r on a.id = r.alunos_id inner join 
disciplinas d on r.disciplinas_id = d.id where d.nome like '%Matemática%';


-- EXERCÍCIO 2
select p.nome, p.grau_academico as grau_acadêmico, d.nome as disciplina from professores p join disciplinas d on p.id = d.professores_id 
where d.nome like '%Inglês%';



-- EXERCÍCIO 3
select a.id, a.nome, a.ra, d.nome as disciplina from alunos a inner join registro_alunos_disciplinas r on a.id = r.alunos_id inner join 
disciplinas d on r.disciplinas_id = d.id;

-- EXERCÍCIO 4

select a.id, a.nome, a.ra, d.nome as disciplina, n.nota from alunos a join registro_alunos_disciplinas r ON a.id = r.alunos_id join 
disciplinas d on r.disciplinas_id = d.id join notas n on r.alunos_id = n.alunos_id and r.disciplinas_id = n.disciplinas_id 
...
where d.nome like '%Ingles%' and n.nota >=7.0;


-- EXERCÍCIO 7
select a.id, a.nome, a.ra, d.nome as disciplina, n.nota from alunos a join registro_alunos_disciplinas r ON a.id = r.alunos_id 
join disciplinas d on r.disciplinas_id = d.id join notas n on r.alunos_id = n.alunos_id and r.disciplinas_id = n.disciplinas_id 
where d.nome like '%Ingles%' and n.nota >8.0;
...
SELECT a.nome AS Aluno, d.nome AS Disciplina, n.nota FROM notas n LEFT JOIN alunos a ON n.alunos_id = a.id
LEFT JOIN disciplinas d ON n.disciplinas_id = d.id WHERE isnull(n.nota);
